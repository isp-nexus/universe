 ...
 * @file Utilities for reading Parquet files.
 */
 ...
 */
export class ParquetReader<T extends {}> extends BaseParquetReader implements AsyncDisposable {
	declare schema: ParquetSchema<T>

	static override async openFile<T extends {} = never>(
		filePath: string,
	...
	static override async openBuffer<T extends {}>(buffer: Buffer, options?: BufferReaderOptions) {
	...
	static override async openEnvelopeReader<T extends {}>(
